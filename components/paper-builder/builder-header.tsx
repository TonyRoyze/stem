...
export function BuilderHeader({
  ...
  }, [importJson, setDocument, setImportJson])
    ...
    <div className="rounded-[32px] border border-white/70 bg-white/85 p-6 shadow-[0_25px_80px_rgba(15,23,42,0.08)] backdrop-blur">
      <div className="flex flex-col gap-6 xl:flex-row xl:items-start xl:justify-between">
        <div className="max-w-3xl">
          ...
          <textarea
            ...
            className="mt-2 w-full resize-none rounded-[28px] border border-slate-200 bg-slate-50 px-5 py-4 text-sm leading-7 text-slate-500 transition outline-none focus:border-emerald-500"
            placeholder="Add a subtitle"
          />
        </div>

        <div className="grid gap-3 sm:grid-cols-3 xl:w-105">
      ...
      {showHeaderActions ? (
        <div className="mt-6 flex flex-wrap gap-3">
          <Button variant="outline" onClick={copyJson} className="min-w-31">
            {isCopied ? (
              <>
          ...
          <Dialog open={isImportOpen} onOpenChange={setIsImportOpen}>
            ...
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Paste the JSON content of a paper to load it into the builder.
              ...
              <div className="mt-4">
                <textarea
                  ...
                  className="min-h-75 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 font-mono text-xs text-slate-700 transition outline-none focus:border-emerald-500"
                />
              </div>
              <DialogFooter>
